...
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $module = $opal.module, $klass = $opal.klass;
  $opal.add_stubs(['$attr_reader', '$raise', '$new', '$call']);
  return (function($base) {
    var self = $module($base, 'ScraperKit');
    ...
    (function($base, $super) {
      ...
      self.$attr_reader("url", "recipe");

      def.$initialize = TMP_1 = function(recipe, url) {
      ...
      return (def.$scrape = function(doc, url) {
        var self = this;
        return self.scraper_block.$call(doc, url);
      }, nil);
    })(self, null)
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      (function($base) {
        ...
        def.$base_url = function(the_base_url) {
          var self = this;
          return self.$metadata()['$[]=']("base_url", the_base_url);
        };
        ...
        def.$scraper_for_url = function(url) {
          ...
          return ($a = ($b = self.$scrapers()).$detect, $a._p = (TMP_2 = function(scraper){var self = TMP_2._s || this, $a, $b;if (scraper == null) scraper = nil;
          if (($a = scraper.$url()['$is_a?']((($b = $scope.Regexp) == null ? $opal.cm('Regexp') : $b))) !== false && $a !== nil) {
              ...
              return (url['$=='](scraper.$url()))
                ...
                ;$opal.donate(self, ["$metadata", "$scrapers", "$title", "$base_url", "$on", "$inherited", "$scraper_for_url"]);
      })(self);
