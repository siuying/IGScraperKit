...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_reader', '$get', '$scraper_for_url', '$recipe', '$==', '$type', '$new', '$scrape', '$raise', '$is_a?', '$instance_eval', '$to_proc']);
  return (function($base) {
    var self = $module($base, 'ScraperKit');
    ...
    (function($base, $super) {
      ...
      return (def.$get = function(url) {
        var $a, $b, self = this, html = nil, scraper = nil, doc = nil;
        ...
        if (html !== false && html !== nil) {
          ...
          if (scraper !== false && scraper !== nil) {
            doc = (function() {if (($a = (scraper.$type()['$==']("text"))) !== false && $a !== nil) {
              return html
              } else {
    ...
    (function($base, $super) {
      ...
      return (def.$scrape = function(doc, url) {
        var $a, $b, $c, $d, self = this;
        if (($a = doc['$is_a?']((($b = $scope.XMLNode) == null ? $opal.cm('XMLNode') : $b))) !== false && $a !== nil) {
          if (self.$type()['$==']("text")) {
          ...
          doc = (function() {if (($a = (self.$type()['$==']("text"))) !== false && $a !== nil) {
            ...
            return (($a = $scope.HTMLDoc) == null ? $opal.cm('HTMLDoc') : $a).$new(doc)
          }; return nil; })();
          return ($a = ($c = (($d = $scope.ScraperScope) == null ? $opal.cm('ScraperScope') : $d).$new(self.$recipe(), self.$type(), doc, url)).$instance_eval, $a._p = self.scraper_block.$to_proc(), $a).call($c);
        };
      }, nil);
    })(self, null);
