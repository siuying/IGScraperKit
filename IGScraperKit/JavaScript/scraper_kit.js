...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_reader', '$get', '$scraper_for_url', '$recipe', '$==', '$type', '$new', '$scrape', '$raise', '$is_a?', '$instance_eval', '$to_proc', '$name', '$url']);
    ...
    (function($base, $super) {
      ...
      def.$scrape = function(the_doc, the_url) {
        ...
        if (($a = the_doc['$is_a?']((($b = $scope.XMLNode) == null ? $opal.cm('XMLNode') : $b))) !== false && $a !== nil) {
          ...
          return ($a = ($b = (($c = $scope.ScraperScope) == null ? $opal.cm('ScraperScope') : $c).$new(self.$recipe(), self.$type(), the_doc, the_url)).$instance_eval, $a._p = self.scraper_block.$to_proc(), $a).call($b);
          } else {
...
(function($opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$recipe_for_url = function(url) {
        var $a, $b, TMP_1, self = this;
        return ($a = ($b = self.$recipes()).$find, $a._p = (TMP_1 = function(recipe){var self = TMP_1._s || this;if (recipe == null) recipe = nil;
        return recipe.$scraper_for_url(url)}, TMP_1._s = self, TMP_1), $a).call($b);
      };

      def.$scraper_for_url = function(url) {
        var $a, $b, TMP_2, self = this, scraper = nil;
        scraper = nil;
        ($a = ($b = self.$recipes()).$find, $a._p = (TMP_2 = function(recipe){var self = TMP_2._s || this;if (recipe == null) recipe = nil;
        return scraper = recipe.$scraper_for_url(url)}, TMP_2._s = self, TMP_2), $a).call($b);
        return scraper;
      };
